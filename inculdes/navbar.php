...
<body class="background">
	 <div class="content">
		...
		<ul class="exo-menu">
			<li><a class="active" href="produits.php"><i class="fa fa-home"></i> Home</a></li>
			<li class="drop-down"><a href="categories.php"><i class="fa fa-cogs"></i> Catégories</a>
				<!--Drop Down-->
				<ul class="drop-down-ul animated fadeIn">
				<li class="flyout-right"><a href="vetech.php">Vêtements & Chaussures</a><!--Flyout Right-->
					<ul class="animated fadeIn">
					
						<li><a href="vetech.php">HYGIN</a></li>
                        <li><a href="vetech.php">FOURNITURE</a></li>
                        <li><a href="vetech.php">VETEMENT</a></li>
                        <li><a href="vetech.php">ALIMENTATION</a></li>
					</ul>
				</li>
				
				
                    <li class="flyout-right"><a href="beas.php">Beauté & Santé</a><!--Flyout Left-->
					<ul class="animated fadeIn">
						<li><a href="beas.php">Hygiène & Soin</a></li>
						<li><a href="beas.php">Pour une peau de bébé</a></li>
                        <li><a href="beas.php">Tous masqués</a></li>
                        <li><a href="beas.php">Vitamine</a></li>
                        <li><a href="beas.php">Maquillage & Parfum </a></li>

                    </ul>
                    <li class="flyout-right"><a href="info.php">informatique</a><!--Flyout Left-->
					<ul class="animated fadeIn">
                        <li><a href="info.php">Ordinateur</a></li>
						<li><a href="info.php">  composants PC</a></li>
                        <li><a href="info.php">Stockage de données</a></li>
                        <li><a href="info.php">Accessoires pour Clavier & Souris</a></li>
</ul>
                    
     
				
				
				<li><a href="autercat.php">Autres catégories</a></li>
			...
			<li class="blog-drop-down"><a href="blog.php"><i class="fa fa-bullhorn"></i> Blog</a>
			...
			<li><a href="users.php"><i class="fa fa-envelope">  </i>Utilisateurs </a>
				<div class="contact">
...
.exo-menu > li > a{
	...
	border-right: 1px  #dcbf5e dotted;
...
.flyout-left ul>li>a {
	...
	border-bottom: 1px dotted #292040;
	-webkit-transition: color 0.2s linear,0.2s linear;
	-moz-transition: color 0.2s linear, 0.2s linear;
	-o-transition: color 0.2s linear,  0.2s linear;
	transition: color 0.2s linear,  0.2s linear;
